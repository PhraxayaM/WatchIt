//
//  ExploreTopTvShowsCollectionViewCell.swift
//  WatchIt
//
...
import Foundation
import UIKit
class ExploreTopTvShowsCollectionViewCell: UICollectionViewCell {
    static let identifier = "ExploreTopTvShowsCollectionViewCell"
    ...
    func configure(with viewModel: MostPopularTVShowsViewModel) {
